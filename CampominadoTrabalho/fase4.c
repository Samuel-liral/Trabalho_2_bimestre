...
char* traduzir(int num){
	switch(num){
		case 1: return "Extremamente Dificil (50%)";
		case 2: return "Excessivamente Dificil (70%)";
		default: NULL;
	}
}
...
void colocarMinas(Tabuleiro *t, int *minas){
    ...
    do{
	    ...
	    printf("[1] Extremamente Dificil (50%%)\n");
	    printf("[2] Excessivamente Dificil (70%%)\n");
	    scanf("%d", &opcao);
